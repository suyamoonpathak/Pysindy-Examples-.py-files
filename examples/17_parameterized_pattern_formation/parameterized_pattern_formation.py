# -*- coding: utf-8 -*-
"""parameterized_pattern_formation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1QxKJTzChGZZu-OpxSyi90KQai0fudPQg
...
which constitute the classical Oregonator model for the BZ chemical reaction. We fix all parameters except $C_b=C_b^c(1 - \mu)$, and a supercritical Hopf bifurcation occurs at $\mu=0$.

Generate several trajectories. This will take a few hours on the first run, but files will be saved and reloaded subsequently.
"""

utils.generate_oregonator_trajectories()

"""In the spatially homogeneous case, a small, stable limit cycle initially emerges for $\mu>0$, but this limit cycle rapid expands in a canard explosion around $\mu\approx 0.15$."""
